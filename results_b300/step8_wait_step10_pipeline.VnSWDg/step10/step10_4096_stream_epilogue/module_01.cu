...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if ((warp_id_in_cta >> 2) == 2) {
    ...
    if (warp_id_in_cta < 8) {
      ...
      alignas(64) half Dreg_f16_ptr[64];
      #pragma unroll 1
      while (1) {
        if (!((_ptr_2[0] < 128))) { break; }
        ...
        for (int f_2 = 0; f_2 < 8; ++f_2) {
          ...
          dr_ptr[0] = (f_2 * 8);
          void* s_ptr = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[98816])), (((((((s_off_ptr[0] >> 3) ^ (((s_off_ptr[0] >> 3) & 56) >> 3)) << 3) + (((f_2 >> 2) & 1) * _ptr_3[0])) + (((f_2 >> 1) & 1) * _ptr_3[1])) + ((f_2 & 1) * _ptr_3[2])) + (s_off_ptr[0] & 7)));
        ...
        for (int f_3 = 0; f_3 < 16; ++f_3) {
          ...
          int cse_v13 = (f_3 * 2);
          dst_lane_indices_0_0_ptr_2[0] = (f_3 * 2);
          alignas(64) int dst_lane_indices_1_0_ptr_2[1];
          dst_lane_indices_1_0_ptr_2[0] = ((f_3 * 2) + 1);
          tvm_builtin_cast_float32x2_float16x2((&(Dreg_f16_ptr[(f_3 * 2)])), (&(Dreg_ptr[(f_3 * 2)])));
        }
        ...
        for (int f_4 = 0; f_4 < 16; ++f_4) {
          ...
          int cse_v14 = (f_4 * 2);
          dst_lane_indices_0_0_ptr_3[0] = (f_4 * 2);
          alignas(64) int dst_lane_indices_1_0_ptr_3[1];
          dst_lane_indices_1_0_ptr_3[0] = ((f_4 * 2) + 1);
          tvm_builtin_cast_float32x2_float16x2((&(Dreg_f16_ptr[((f_4 * 2) + 32)])), (&(Dreg_ptr[(f_4 * 2)])));
        }
        ...
        for (int f_5 = 0; f_5 < 8; ++f_5) {
          ...
          dr_ptr_1[0] = (f_5 * 8);
          void* s_ptr_1 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[98816])), (((((((s_off_ptr_1[0] >> 3) ^ (((s_off_ptr_1[0] >> 3) & 56) >> 3)) << 3) + (((f_5 >> 2) & 1) * _ptr_4[0])) + (((f_5 >> 1) & 1) * _ptr_4[1])) + ((f_5 & 1) * _ptr_4[2])) + (s_off_ptr_1[0] & 7)));
          void* r_ptr_1 = (void*)tvm_builtin_pointer_offset((&(Dreg_f16_ptr[0])), dr_ptr_1[0]);
        ...
        for (int f_6 = 0; f_6 < 16; ++f_6) {
          ...
          int cse_v16 = (f_6 * 2);
          dst_lane_indices_0_0_ptr_4[0] = (f_6 * 2);
          alignas(64) int dst_lane_indices_1_0_ptr_4[1];
          dst_lane_indices_1_0_ptr_4[0] = ((f_6 * 2) + 1);
          tvm_builtin_cast_float32x2_float16x2((&(Dreg_f16_ptr[(f_6 * 2)])), (&(Dreg_ptr[(f_6 * 2)])));
        }
        ...
        for (int f_7 = 0; f_7 < 16; ++f_7) {
          ...
          int cse_v17 = (f_7 * 2);
          dst_lane_indices_0_0_ptr_5[0] = (f_7 * 2);
          alignas(64) int dst_lane_indices_1_0_ptr_5[1];
          dst_lane_indices_1_0_ptr_5[0] = ((f_7 * 2) + 1);
          tvm_builtin_cast_float32x2_float16x2((&(Dreg_f16_ptr[((f_7 * 2) + 32)])), (&(Dreg_ptr[(f_7 * 2)])));
        }
        ...
        for (int f_8 = 0; f_8 < 8; ++f_8) {
          ...
          dr_ptr_2[0] = (f_8 * 8);
          void* s_ptr_2 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[98816])), (((((((s_off_ptr_2[0] >> 3) ^ (((s_off_ptr_2[0] >> 3) & 56) >> 3)) << 3) + (((f_8 >> 2) & 1) * _ptr_5[0])) + (((f_8 >> 1) & 1) * _ptr_5[1])) + ((f_8 & 1) * _ptr_5[2])) + (s_off_ptr_2[0] & 7)));
          void* r_ptr_2 = (void*)tvm_builtin_pointer_offset((&(Dreg_f16_ptr[0])), dr_ptr_2[0]);
        ...
        tvm_builtin_ptx_tcgen05_wait_ld();
        for (int f_9 = 0; f_9 < 16; ++f_9) {
          alignas(64) int dst_lane_indices_0_0_ptr_6[1];
          int cse_v19 = (f_9 * 2);
          dst_lane_indices_0_0_ptr_6[0] = (f_9 * 2);
          alignas(64) int dst_lane_indices_1_0_ptr_6[1];
          dst_lane_indices_1_0_ptr_6[0] = ((f_9 * 2) + 1);
          tvm_builtin_cast_float32x2_float16x2((&(Dreg_f16_ptr[(f_9 * 2)])), (&(Dreg_ptr[(f_9 * 2)])));
        }
        ...
        tvm_builtin_ptx_tcgen05_wait_ld();
        for (int f_10 = 0; f_10 < 16; ++f_10) {
          alignas(64) int dst_lane_indices_0_0_ptr_7[1];
          int cse_v20 = (f_10 * 2);
          dst_lane_indices_0_0_ptr_7[0] = (f_10 * 2);
          alignas(64) int dst_lane_indices_1_0_ptr_7[1];
          dst_lane_indices_1_0_ptr_7[0] = ((f_10 * 2) + 1);
          tvm_builtin_cast_float32x2_float16x2((&(Dreg_f16_ptr[((f_10 * 2) + 32)])), (&(Dreg_ptr[(f_10 * 2)])));
        }
        ...
        for (int f_11 = 0; f_11 < 8; ++f_11) {
          ...
          void* r_ptr_3 = (void*)tvm_builtin_pointer_offset((&(Dreg_f16_ptr[0])), dr_ptr_3[0]);
