      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 64; ++k) {
            ...
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 33280)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), ((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        for (int f_8 = 0; f_8 < 8; ++f_8) {
          ...
          dr_ptr[0] = (f_8 * 8);
          void* s_ptr = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[49664])), (((((((s_off_ptr[0] >> 3) ^ (((s_off_ptr[0] >> 3) & 56) >> 3)) << 3) + (((f_8 >> 2) & 1) * _ptr_3[0])) + (((f_8 >> 1) & 1) * _ptr_3[1])) + ((f_8 & 1) * _ptr_3[2])) + (s_off_ptr[0] & 7)));
        ...
        int cse_v32 = (((warp_id_in_cta >> 2) * 8192) + 49664);
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 8192) + 49664)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (_ptr_1[0] * 256), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
        ...
        for (int f_9 = 0; f_9 < 8; ++f_9) {
          ...
          dr_ptr_1[0] = (f_9 * 8);
          void* s_ptr_1 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[49664])), (((((((s_off_ptr_1[0] >> 3) ^ (((s_off_ptr_1[0] >> 3) & 56) >> 3)) << 3) + (((f_9 >> 2) & 1) * _ptr_4[0])) + (((f_9 >> 1) & 1) * _ptr_4[1])) + ((f_9 & 1) * _ptr_4[2])) + (s_off_ptr_1[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 8192) + 49664)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 256) + 64), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
        ...
        for (int f_10 = 0; f_10 < 8; ++f_10) {
          ...
          dr_ptr_2[0] = (f_10 * 8);
          void* s_ptr_2 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[49664])), (((((((s_off_ptr_2[0] >> 3) ^ (((s_off_ptr_2[0] >> 3) & 56) >> 3)) << 3) + (((f_10 >> 2) & 1) * _ptr_5[0])) + (((f_10 >> 1) & 1) * _ptr_5[1])) + ((f_10 & 1) * _ptr_5[2])) + (s_off_ptr_2[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 8192) + 49664)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 256) + 128), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
        ...
        for (int f_11 = 0; f_11 < 8; ++f_11) {
          ...
          dr_ptr_3[0] = (f_11 * 8);
          void* s_ptr_3 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[49664])), (((((((s_off_ptr_3[0] >> 3) ^ (((s_off_ptr_3[0] >> 3) & 56) >> 3)) << 3) + (((f_11 >> 2) & 1) * _ptr_6[0])) + (((f_11 >> 1) & 1) * _ptr_6[1])) + ((f_11 & 1) * _ptr_6[2])) + (s_off_ptr_3[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 8192) + 49664)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 256) + 192), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
