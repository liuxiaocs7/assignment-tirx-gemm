    ...
    def kernel(
        ...
        def tma_load(k_st, stage):
            for consumer in T.unroll(NUM_CONSUMER):
                ...
                Tx.copy_async(Asmem[stage, consumer, :, :],
                    ...
                    while tile_scheduler.valid():
                        if UNROLL_RING:
                            for ring in range(K_TILES // PIPE_DEPTH):
                                ...
                                tma_phase.phase = tma_phase.phase ^ 1
                        else:
                        ...
                        while tile_scheduler.valid():
                            ...
                            if UNROLL_RING:
                                for ring in range(K_TILES // PIPE_DEPTH):
                                    ...
                                    mma_phase.phase = mma_phase.phase ^ 1
                            else:
                                for k in range(K_TILES):
