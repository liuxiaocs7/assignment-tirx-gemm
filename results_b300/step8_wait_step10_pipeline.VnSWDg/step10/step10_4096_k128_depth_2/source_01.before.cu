...
__forceinline__ __device__ void ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d_mbar_addr(void* dst, unsigned int mbar_addr, unsigned long long tensormap_addr, uint16_t cta_mask, unsigned long long cache_policy, int coord0, int coord1, int coord2) {
    unsigned int dst_addr = __cvta_generic_to_shared(dst);
    asm volatile(
        "cp.async.bulk.tensor.3d.shared::cluster.global.mbarrier::complete_tx::bytes.cta_group::2 [%0], [%1, {%3, %4, %5}], [%2];"
        :
...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  tvm_builtin_ptx_tcgen05_encode_matrix_descriptor((&(descA_ptr[0])), (&(((half*)pool_buf_ptr)[512])), 1024, 64, 3);
  alignas(64) uint64_t descB_ptr[1];
  tvm_builtin_ptx_tcgen05_encode_matrix_descriptor((&(descB_ptr[0])), (&(((half*)pool_buf_ptr)[66048])), 1024, 64, 3);
  ...
  if ((warp_id_in_cta >> 2) == 2) {
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 32; ++k) {
            tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 3)])), (tma_phase_phase_ptr[0] ^ 0));
            int cse_v7 = (k * 2);
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 32768) + 512)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, 0, ((_ptr[0] * 512) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)), (k * 2));
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 32768) + 16896)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, 0, (((_ptr[0] * 512) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)) + 256), (k * 2));
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 16384) + 66048)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, ((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)), (k * 2));
            if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
              alignas(64) bool actual_pred_ptr[1];
              actual_pred_ptr[0] = (bool)1;
              tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared_cluster_remote_pred((&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), 196608, 0, actual_pred_ptr[0]);
            }
            tma_phase_stage_ptr[0] = (tma_phase_stage_ptr[0] + 1);
            if (tma_phase_stage_ptr[0] == 2) {
              tma_phase_stage_ptr[0] = 0;
          ...
          if ((bool)1 & (_ptr_2[0] < 128)) {
            ...
            int cse_v24 = ((group_id_1 * 8) + (within_group_1 & 7));
      ...
      if ((warp_id_in_cta & 3) < 2) {
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              if (!((_ptr_2[0] < 128))) { break; }
              tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[((warp_id_in_cta & 3) + 7)])), (ld_phase_phase_ptr[0] ^ 0));
              ...
              for (int k_1 = 0; k_1 < 32; ++k_1) {
                ...
                int cse_v25 = ((warp_id_in_cta & 3) * 2048);
                uint cse_v30 = ((uint)((warp_id_in_cta & 3) * 256));
                ptx_tcgen05_mma_cta_2_kind_f16_SS((((uint*)pool_buf_ptr)[0] + ((uint)((warp_id_in_cta & 3) * 256))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048))), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (mma_phase_stage_ptr[0] * 2048)), (uint)272629776, (0 < k_1), 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((((uint*)pool_buf_ptr)[0] + ((uint)((warp_id_in_cta & 3) * 256))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048)) + 2)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 2)), (uint)272629776, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((((uint*)pool_buf_ptr)[0] + ((uint)((warp_id_in_cta & 3) * 256))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048)) + 4)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 4)), (uint)272629776, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((((uint*)pool_buf_ptr)[0] + ((uint)((warp_id_in_cta & 3) * 256))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048)) + 6)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 6)), (uint)272629776, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((((uint*)pool_buf_ptr)[0] + ((uint)((warp_id_in_cta & 3) * 256))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048)) + 1024)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1024)), (uint)272629776, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((((uint*)pool_buf_ptr)[0] + ((uint)((warp_id_in_cta & 3) * 256))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048)) + 1026)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1026)), (uint)272629776, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((((uint*)pool_buf_ptr)[0] + ((uint)((warp_id_in_cta & 3) * 256))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048)) + 1028)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1028)), (uint)272629776, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((((uint*)pool_buf_ptr)[0] + ((uint)((warp_id_in_cta & 3) * 256))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048)) + 1030)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1030)), (uint)272629776, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_commit_cta_group_2_multicast((&(((uint64_t*)pool_buf_ptr)[(mma_phase_stage_ptr[0] + 3)])), 3);
                mma_phase_stage_ptr[0] = (mma_phase_stage_ptr[0] + 1);
                if (mma_phase_stage_ptr[0] == 2) {
                  mma_phase_stage_ptr[0] = 0;
              ...
              if ((bool)1 & (_ptr_2[0] < 128)) {
                ...
                int cse_v26 = ((group_id_2 * 8) + (within_group_2 & 7));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        if (!((_ptr_2[0] < 128))) { break; }
        tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[((warp_id_in_cta >> 2) + 5)])), (wb_phase_phase_ptr[0] ^ 0));
        wb_phase_phase_ptr[0] = (wb_phase_phase_ptr[0] ^ 1);
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        int cse_v27 = ((warp_id_in_cta >> 2) * 256);
        ...
        int cse_v31 = ((warp_id_in_cta * 2048) + ((((int)threadIdx.x) & 31) * 64));
        ...
        tvm_builtin_ptx_fence_proxy_async_shared_cta();
        int cse_v28 = ((warp_id_in_cta >> 2) + 10);
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        int cse_v32 = (((warp_id_in_cta >> 2) * 8192) + 98816);
        ...
        if ((bool)1 & (_ptr_2[0] < 128)) {
          ...
          int cse_v29 = ((group_id_3 * 8) + (within_group_3 & 7));
