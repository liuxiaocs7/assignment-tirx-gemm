...
__forceinline__ __device__ void tvm_probe_ptx_mbarrier_wait_64ns(void* barrier, int phase) {
    unsigned int barrier_addr_int = __cvta_generic_to_shared(barrier);
...
extern "C" __global__ void __launch_bounds__(128) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap A_tensormap_1, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap B_tensormap_1, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if ((warp_id_in_cta % 4) == 0) {
    ...
    tvm_builtin_ptx_tcgen05_alloc_cta_group_1((&(((uint*)pool_buf_ptr)[0])), 128);
  ...
  phase_mma_ptr[0] = 0;
  int cse_v3 = (((int)blockIdx.x) * 128);
  if ((warp_id_in_cta % 4) == 0) {
    if (tvm_builtin_elect_one_sync_op() != (uint)0) {
      ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[512])), (&(((uint64_t*)pool_buf_ptr)[1])), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, 0, (((int)blockIdx.x) * 128));
      int cse_v4 = (((int)blockIdx.y) * 128);
      ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[16896])), (&(((uint64_t*)pool_buf_ptr)[1])), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, (((int)blockIdx.y) * 128));
      tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[1])), 32768);
      ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[8704])), (&(((uint64_t*)pool_buf_ptr)[2])), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, 64, (((int)blockIdx.x) * 128));
      ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[25088])), (&(((uint64_t*)pool_buf_ptr)[2])), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 64, (((int)blockIdx.y) * 128));
      tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[2])), 32768);
      for (int ring = 0; ring < 8; ++ring) {
        int cse_v5 = (ring & 1);
        tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[1])), (ring & 1));
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], 0), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], 0), (uint)136314896, (0 < ring), 0, 0, 0, 0);
        ...
        tvm_probe_ptx_mbarrier_wait_64ns((&(((uint64_t*)pool_buf_ptr)[3])), phase_mma_ptr[0]);
        phase_mma_ptr[0] = (phase_mma_ptr[0] ^ 1);
        int cse_v6 = (ring * 128);
        if (ring < 7) {
          int cse_v8 = ((ring * 128) + 128);
          ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[512])), (&(((uint64_t*)pool_buf_ptr)[1])), ((unsigned long long)(&(A_tensormap_1))), 0, (uint64_t)0, ((ring * 128) + 128), (((int)blockIdx.x) * 128));
          ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[16896])), (&(((uint64_t*)pool_buf_ptr)[1])), ((unsigned long long)(&(B_tensormap_1))), 0, (uint64_t)0, ((ring * 128) + 128), (((int)blockIdx.y) * 128));
          tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[1])), 32768);
        }
        tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[2])), (ring & 1));
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], 1024), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], 1024), (uint)136314896, (bool)1, 0, 0, 0, 0);
        ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], 1026), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], 1026), (uint)136314896, (bool)1, 0, 0, 0, 0);
        ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], 1028), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], 1028), (uint)136314896, (bool)1, 0, 0, 0, 0);
        ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], 1030), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], 1030), (uint)136314896, (bool)1, 0, 0, 0, 0);
        ptx_tcgen05_commit_cta_group_1((&(((uint64_t*)pool_buf_ptr)[3])));
        tvm_probe_ptx_mbarrier_wait_64ns((&(((uint64_t*)pool_buf_ptr)[3])), phase_mma_ptr[0]);
        phase_mma_ptr[0] = (phase_mma_ptr[0] ^ 1);
        if (ring < 7) {
          int cse_v9 = ((ring * 128) + 192);
          ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[8704])), (&(((uint64_t*)pool_buf_ptr)[2])), ((unsigned long long)(&(A_tensormap_1))), 0, (uint64_t)0, ((ring * 128) + 192), (((int)blockIdx.x) * 128));
          ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[25088])), (&(((uint64_t*)pool_buf_ptr)[2])), ((unsigned long long)(&(B_tensormap_1))), 0, (uint64_t)0, ((ring * 128) + 192), (((int)blockIdx.y) * 128));
          tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[2])), 32768);
        }
      }
      tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
  ...
  tvm_builtin_cuda_cta_sync();
  if ((warp_id_in_cta % 4) == 0) {
    tvm_builtin_ptx_tcgen05_dealloc_cta_group_1(((uint*)pool_buf_ptr)[0], 128);
  }
}
