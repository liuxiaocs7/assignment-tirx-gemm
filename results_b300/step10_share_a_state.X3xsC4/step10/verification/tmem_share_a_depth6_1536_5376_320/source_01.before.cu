...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if (tvm_builtin_cuda_thread_rank() == 0) {
    ...
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[9])), 2);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[10])), 2);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[11])), 2);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[12])), 2);
  }
  if (tvm_builtin_cuda_thread_rank() == 0) {
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[13])), 1);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[14])), 1);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[15])), 1);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[16])), 1);
  }
  if (tvm_builtin_cuda_thread_rank() == 0) {
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[17])), 256);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[18])), 256);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[19])), 256);
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[20])), 256);
  }
  ...
  int cse_v23 = ((((int)blockIdx.x) % 12) >> 1);
  int tile_row = ((((int)blockIdx.x) % 12) >> 1);
  int cse_v5 = (((int)blockIdx.x) / 12);
  int tile_col = (((int)blockIdx.x) / 12);
  _ptr[0] = ((((int)blockIdx.x) % 12) >> 1);
  _ptr_1[0] = (((int)blockIdx.x) / 12);
  ...
  if ((warp_id_in_cta >> 2) == 2) {
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        #pragma unroll 1
        while (1) {
          if (!((_ptr_2[0] < 126))) { break; }
          for (int k = 0; k < 5; ++k) {
            tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 7)])), (tma_phase_phase_ptr[0] ^ 0));
            int cse_v6 = (k * 64);
            int cse_v7 = (((int)tvm_builtin_cluster_ctaid_x()) * 64);
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 49664)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), ((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 64)));
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 53760)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), (((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 64)) + 128));
            ...
            if (tma_phase_stage_ptr[0] == 6) {
              tma_phase_stage_ptr[0] = 0;
              tma_phase_phase_ptr[0] = (tma_phase_phase_ptr[0] ^ 1);
            }
          }
          _ptr_2[0] = (_ptr_2[0] + 63);
          tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
          int rem_1 = _ptr_2[0];
          int cse_v9 = ((rem_1 % 6) + (6 & ((rem_1 % 6) >> 31)));
          int tile_row_1 = ((rem_1 % 6) + (6 & ((rem_1 % 6) >> 31)));
          int cse_v10 = ((rem_1 / 6) + ((rem_1 % 6) >> 31));
          int tile_col_1 = ((rem_1 / 6) + ((rem_1 % 6) >> 31));
          _ptr[0] = ((rem_1 % 6) + (6 & ((rem_1 % 6) >> 31)));
          _ptr_1[0] = ((rem_1 / 6) + ((rem_1 % 6) >> 31));
        }
      }
    } else {
      if ((warp_id_in_cta & 3) < 2) {
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              if (!((_ptr_2[0] < 126))) { break; }
              tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[(((ld_phase_stage_ptr[0] * 2) + (warp_id_in_cta & 3)) + 17)])), (ld_phase_phase_ptr[0] ^ 0));
              for (int k_1 = 0; k_1 < 5; ++k_1) {
                ...
                int cse_v24 = ((warp_id_in_cta & 3) * 128);
                int cse_v25 = ((warp_id_in_cta & 3) * 512);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((mma_tmem_base + ((uint)((ld_phase_stage_ptr[0] * 256) + ((warp_id_in_cta & 3) * 128)))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (mma_phase_stage_ptr[0] * 1024)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + ((warp_id_in_cta & 3) * 512))), (uint)270532624, (0 < k_1), 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((mma_tmem_base + ((uint)((ld_phase_stage_ptr[0] * 256) + ((warp_id_in_cta & 3) * 128)))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 2)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((mma_phase_stage_ptr[0] * 1024) + ((warp_id_in_cta & 3) * 512)) + 2)), (uint)270532624, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((mma_tmem_base + ((uint)((ld_phase_stage_ptr[0] * 256) + ((warp_id_in_cta & 3) * 128)))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 4)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((mma_phase_stage_ptr[0] * 1024) + ((warp_id_in_cta & 3) * 512)) + 4)), (uint)270532624, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((mma_tmem_base + ((uint)((ld_phase_stage_ptr[0] * 256) + ((warp_id_in_cta & 3) * 128)))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 6)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((mma_phase_stage_ptr[0] * 1024) + ((warp_id_in_cta & 3) * 512)) + 6)), (uint)270532624, (bool)1, 0, 0, 0, 0, 0, 0, 0, 0);
                ptx_tcgen05_commit_cta_group_2_multicast((&(((uint64_t*)pool_buf_ptr)[(mma_phase_stage_ptr[0] + 7)])), 3);
                mma_phase_stage_ptr[0] = (mma_phase_stage_ptr[0] + 1);
                if (mma_phase_stage_ptr[0] == 6) {
                  mma_phase_stage_ptr[0] = 0;
                  mma_phase_phase_ptr[0] = (mma_phase_phase_ptr[0] ^ 1);
                }
              }
              ptx_tcgen05_commit_cta_group_2_multicast((&(((uint64_t*)pool_buf_ptr)[(((ld_phase_stage_ptr[0] * 2) + (warp_id_in_cta & 3)) + 13)])), 3);
              ...
              tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
              int rem_2 = _ptr_2[0];
              int cse_v11 = ((rem_2 % 6) + (6 & ((rem_2 % 6) >> 31)));
              int tile_row_2 = ((rem_2 % 6) + (6 & ((rem_2 % 6) >> 31)));
              int cse_v12 = ((rem_2 / 6) + ((rem_2 % 6) >> 31));
              int tile_col_2 = ((rem_2 / 6) + ((rem_2 % 6) >> 31));
              _ptr[0] = ((rem_2 % 6) + (6 & ((rem_2 % 6) >> 31)));
              _ptr_1[0] = ((rem_2 / 6) + ((rem_2 % 6) >> 31));
            }
          }
        }
      }
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        if (!((_ptr_2[0] < 126))) { break; }
        tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[(((wb_phase_stage_ptr[0] * 2) + (warp_id_in_cta >> 2)) + 13)])), (wb_phase_phase_ptr[0] ^ 0));
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        int cse_v26 = ((warp_id_in_cta >> 2) * 128);
        ...
        tvm_builtin_ptx_mbarrier_arrive_shared_cluster_remote_pred((&(((uint64_t*)pool_buf_ptr)[(((wb_phase_stage_ptr[0] * 2) + (warp_id_in_cta >> 2)) + 17)])), 0, actual_pred_ptr_1[0]);
        ...
        for (int f_4 = 0; f_4 < 4; ++f_4) {
          ...
          dr_ptr[0] = (f_4 * 8);
          void* s_ptr = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[98816])), ((((((s_off_ptr[0] >> 3) ^ (((s_off_ptr[0] >> 3) & 24) >> 3)) << 3) + (((f_4 >> 1) & 1) * _ptr_3[0])) + ((f_4 & 1) * _ptr_3[1])) + (s_off_ptr[0] & 7)));
        ...
        int cse_v29 = (((warp_id_in_cta >> 2) * 4096) + 98816);
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 98816)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 256) + ((warp_id_in_cta >> 2) * 128)), ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
        ...
        for (int f_5 = 0; f_5 < 4; ++f_5) {
          ...
          dr_ptr_1[0] = (f_5 * 8);
          void* s_ptr_1 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[98816])), ((((((s_off_ptr_1[0] >> 3) ^ (((s_off_ptr_1[0] >> 3) & 24) >> 3)) << 3) + (((f_5 >> 1) & 1) * _ptr_4[0])) + ((f_5 & 1) * _ptr_4[1])) + (s_off_ptr_1[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 98816)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (((_ptr_1[0] * 256) + ((warp_id_in_cta >> 2) * 128)) + 32), ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
        ...
        for (int f_6 = 0; f_6 < 4; ++f_6) {
          ...
          dr_ptr_2[0] = (f_6 * 8);
          void* s_ptr_2 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[98816])), ((((((s_off_ptr_2[0] >> 3) ^ (((s_off_ptr_2[0] >> 3) & 24) >> 3)) << 3) + (((f_6 >> 1) & 1) * _ptr_5[0])) + ((f_6 & 1) * _ptr_5[1])) + (s_off_ptr_2[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 98816)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (((_ptr_1[0] * 256) + ((warp_id_in_cta >> 2) * 128)) + 64), ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
        ...
        for (int f_7 = 0; f_7 < 4; ++f_7) {
          ...
          dr_ptr_3[0] = (f_7 * 8);
          void* s_ptr_3 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[98816])), ((((((s_off_ptr_3[0] >> 3) ^ (((s_off_ptr_3[0] >> 3) & 24) >> 3)) << 3) + (((f_7 >> 1) & 1) * _ptr_6[0])) + ((f_7 & 1) * _ptr_6[1])) + (s_off_ptr_3[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 98816)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (((_ptr_1[0] * 256) + ((warp_id_in_cta >> 2) * 128)) + 96), ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
        ...
        tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
        int rem_3 = _ptr_2[0];
        int cse_v21 = ((rem_3 % 6) + (6 & ((rem_3 % 6) >> 31)));
        int tile_row_3 = ((rem_3 % 6) + (6 & ((rem_3 % 6) >> 31)));
        int cse_v22 = ((rem_3 / 6) + ((rem_3 % 6) >> 31));
        int tile_col_3 = ((rem_3 / 6) + ((rem_3 % 6) >> 31));
        _ptr[0] = ((rem_3 % 6) + (6 & ((rem_3 % 6) >> 31)));
        _ptr_1[0] = ((rem_3 / 6) + ((rem_3 % 6) >> 31));
      }
    }
  }
  tvm_builtin_cuda_cluster_sync();
