        ...
        if (tvm_builtin_elect_one_sync_op() != (uint)0) {
          ...
          while (1) {
            ...
            for (int k_1 = 0; k_1 < 16; ++k_1) {
              ...
              ptx_tcgen05_mma_cta_1_kind_f16_SS(mma_tmem_base, tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (mma_phase_stage_ptr[0] * 1024)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (mma_phase_stage_ptr[0] * 1024)), (uint)136314896, (0 < k_1), 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(mma_tmem_base, tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 2)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 2)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(mma_tmem_base, tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 4)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 4)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(mma_tmem_base, tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 6)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 6)), (uint)136314896, (bool)1, 0, 0, 0, 0);
