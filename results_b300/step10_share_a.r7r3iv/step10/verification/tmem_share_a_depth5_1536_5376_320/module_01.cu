...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  tvm_builtin_ptx_tcgen05_encode_matrix_descriptor((&(descB_ptr[0])), (&(((half*)pool_buf_ptr)[41472])), 0, 64, 3);
      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 5; ++k) {
            ...
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 41472)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), ((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 64)));
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 45568)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), (((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 64)) + 128));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 82432)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 256) + ((warp_id_in_cta >> 2) * 128)), ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 82432)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (((_ptr_1[0] * 256) + ((warp_id_in_cta >> 2) * 128)) + 32), ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 82432)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (((_ptr_1[0] * 256) + ((warp_id_in_cta >> 2) * 128)) + 64), ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 82432)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (((_ptr_1[0] * 256) + ((warp_id_in_cta >> 2) * 128)) + 96), ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
