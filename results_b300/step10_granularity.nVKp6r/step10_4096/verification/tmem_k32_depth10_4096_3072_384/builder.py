def hgemm_v10(M, N, K):
    ...
    BLK_K = 32 if TMEM_BUFFERS == 2 else 64
    PIPE_DEPTH = 10 if TMEM_BUFFERS == 2 else 4
    K_TILES = K // BLK_K
    ...
    A_layout = mma_shared_layout(a_type, INPUT_SWIZZLE, (PIPE_DEPTH, NUM_CONSUMER, BLK_M, BLK_K))
    B_layout = mma_shared_layout(b_type, INPUT_SWIZZLE, (PIPE_DEPTH, BLK_N, BLK_K))
