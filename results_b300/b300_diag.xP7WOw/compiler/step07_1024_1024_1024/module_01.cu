      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 16; ++k) {
            ...
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 16896)])), (&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), (_ptr_1[0] * 128));
    ...
    if ((warp_id_in_cta >> 2) == 0) {
      ...
      while (1) {
        ...
        for (int f_4 = 0; f_4 < 8; ++f_4) {
          ...
          dr_ptr[0] = (f_4 * 8);
          void* s_ptr = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[33280])), (((((((s_off_ptr[0] >> 3) ^ (((s_off_ptr[0] >> 3) & 56) >> 3)) << 3) + (((f_4 >> 2) & 1) * _ptr_3[0])) + (((f_4 >> 1) & 1) * _ptr_3[1])) + ((f_4 & 1) * _ptr_3[2])) + (s_off_ptr[0] & 7)));
        ...
        if (warp_id_in_cta == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[33280])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (_ptr_1[0] * 128), (_ptr[0] * 128));
        ...
        for (int f_5 = 0; f_5 < 8; ++f_5) {
          ...
          dr_ptr_1[0] = (f_5 * 8);
          void* s_ptr_1 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[33280])), (((((((s_off_ptr_1[0] >> 3) ^ (((s_off_ptr_1[0] >> 3) & 56) >> 3)) << 3) + (((f_5 >> 2) & 1) * _ptr_4[0])) + (((f_5 >> 1) & 1) * _ptr_4[1])) + ((f_5 & 1) * _ptr_4[2])) + (s_off_ptr_1[0] & 7)));
        ...
        if (warp_id_in_cta == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[33280])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 128) + 64), (_ptr[0] * 128));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
