      ...
      if ((warp_id_in_cta & 3) < 2) {
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              if (!((_ptr_2[0] < 128))) { break; }
              tirx_profile_start(profile_state_ptr, (bool)1);
              tirx_profile_mark(profile_state_ptr, (bool)1);
              tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[((warp_id_in_cta & 3) + 11)])), (ld_phase_phase_ptr[0] ^ 0));
              tirx_profile_add_handoff(profile_state_ptr, (bool)1);
              ...
              for (int k_1 = 0; k_1 < 64; ++k_1) {
                ...
                tirx_profile_add_wait(profile_state_ptr, (bool)1);
                tirx_profile_mark(profile_state_ptr, (bool)1);
                ...
                tirx_profile_add_work(profile_state_ptr, (bool)1);
              }
              ptx_tcgen05_commit_cta_group_2_multicast((&(((uint64_t*)pool_buf_ptr)[((warp_id_in_cta & 3) + 9)])), 3);
              tirx_profile_finish(profile_state_ptr, (&(Profile_ptr[(((((int)blockIdx.x) * 44) + (tile_scheduler_tile_count_ptr[0] * 22)) + ((warp_id_in_cta & 3) * 11))])), _ptr[0], _ptr_1[0], (bool)1);
              _ptr_2[0] = (_ptr_2[0] + 74);
              tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
              if ((bool)1 & (_ptr_2[0] < 128)) {
