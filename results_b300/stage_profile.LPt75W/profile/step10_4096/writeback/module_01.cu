...
#endif
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap, int64_t* __restrict__ Profile_ptr);
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap, int64_t* __restrict__ Profile_ptr) {
  ...
  if ((warp_id_in_cta >> 2) == 2) {
    ...
    if (warp_id_in_cta < 8) {
      ...
      alignas(64) uint64_t profile_state_ptr[8];
      #pragma unroll 1
      while (1) {
        if (!((_ptr_2[0] < 128))) { break; }
        tirx_profile_start(profile_state_ptr, (((warp_id_in_cta % 4) == 0) & ((((int)threadIdx.x) % 32) == 0)));
        tirx_profile_mark(profile_state_ptr, (((warp_id_in_cta % 4) == 0) & ((((int)threadIdx.x) % 32) == 0)));
        tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[((warp_id_in_cta >> 2) + 9)])), (wb_phase_phase_ptr[0] ^ 0));
        tirx_profile_add_wait(profile_state_ptr, (((warp_id_in_cta % 4) == 0) & ((((int)threadIdx.x) % 32) == 0)));
        ...
        tirx_profile_add_work(profile_state_ptr, (((warp_id_in_cta % 4) == 0) & ((((int)threadIdx.x) % 32) == 0)));
        tirx_profile_mark(profile_state_ptr, (((warp_id_in_cta % 4) == 0) & ((((int)threadIdx.x) % 32) == 0)));
        ...
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        tirx_profile_add_epilogue(profile_state_ptr, (((warp_id_in_cta % 4) == 0) & ((((int)threadIdx.x) % 32) == 0)));
        tirx_profile_finish(profile_state_ptr, (&(Profile_ptr[(((((int)blockIdx.x) * 44) + (tile_scheduler_tile_count_ptr[0] * 22)) + ((warp_id_in_cta >> 2) * 11))])), _ptr[0], _ptr_1[0], (((warp_id_in_cta % 4) == 0) & ((((int)threadIdx.x) % 32) == 0)));
        _ptr_2[0] = (_ptr_2[0] + 74);
        tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
        if ((bool)1 & (_ptr_2[0] < 128)) {
