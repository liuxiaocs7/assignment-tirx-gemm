    ...
    def kernel(
        ...
        if wg_id == 1:
            ...
            while tile_scheduler.valid():
                ...
                T.cuda.func_call("tirx_profile_finish", profile_state.data, Profile.ptr_to([bx, tile_scheduler.tile_count, 0, 0]), tile_scheduler.m_idx, tile_scheduler.n_idx, (warp_id == 0) & (lane_id == 0), source_code=PROFILE_SOURCE)
                tile_scheduler.next_tile()
