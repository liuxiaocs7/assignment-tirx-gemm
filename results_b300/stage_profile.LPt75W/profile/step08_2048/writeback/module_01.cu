...
extern "C" __global__ void __launch_bounds__(256) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap, int64_t* __restrict__ Profile_ptr);
extern "C" __global__ void __launch_bounds__(256) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap, int64_t* __restrict__ Profile_ptr) {
  ...
  if (tvm_builtin_cuda_thread_rank() == 0) {
    tvm_builtin_ptx_mbarrier_init((&(((uint64_t*)pool_buf_ptr)[10])), 128);
  }
  ...
  if ((warp_id_in_cta >> 2) == 1) {
      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 32; ++k) {
            ...
            int cse_v6 = (k * 64);
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 512)])), (&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, (k * 64), (_ptr[0] * 128));
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 33280)])), (&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), (_ptr_1[0] * 128));
            tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), 32768);
        ...
        if (tvm_builtin_elect_one_sync_op() != (uint)0) {
          ...
          while (1) {
            ...
            for (int k_1 = 0; k_1 < 32; ++k_1) {
              tirx_tma_wait_64ns((&(((uint64_t*)pool_buf_ptr)[(mma_phase_stage_ptr[0] + 1)])), (mma_phase_phase_ptr[0] ^ 0));
              tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (mma_phase_stage_ptr[0] * 1024)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (mma_phase_stage_ptr[0] * 1024)), (uint)136314896, (0 < k_1), 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 2)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 2)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 4)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 4)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 6)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 1024) + 6)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_commit_cta_group_1((&(((uint64_t*)pool_buf_ptr)[(mma_phase_stage_ptr[0] + 5)])));
            ...
            ptx_tcgen05_commit_cta_group_1((&(((uint64_t*)pool_buf_ptr)[9])));
            _ptr_2[0] = (_ptr_2[0] + 148);
            tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
            if ((bool)1 & (_ptr_2[0] < 256)) {
    ...
    if ((warp_id_in_cta >> 2) == 0) {
      ...
      while (1) {
        if (!((_ptr_2[0] < 256))) { break; }
        tirx_profile_start(profile_state_ptr, ((warp_id_in_cta == 0) & ((((int)threadIdx.x) % 32) == 0)));
        tirx_profile_mark(profile_state_ptr, ((warp_id_in_cta == 0) & ((((int)threadIdx.x) % 32) == 0)));
        tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[9])), (wb_phase_phase_ptr[0] ^ 0));
        tirx_profile_add_wait(profile_state_ptr, ((warp_id_in_cta == 0) & ((((int)threadIdx.x) % 32) == 0)));
        ...
        tvm_builtin_ptx_mbarrier_arrive_shared((&(((uint64_t*)pool_buf_ptr)[10])));
        tirx_profile_add_work(profile_state_ptr, ((warp_id_in_cta == 0) & ((((int)threadIdx.x) % 32) == 0)));
        tirx_profile_mark(profile_state_ptr, ((warp_id_in_cta == 0) & ((((int)threadIdx.x) % 32) == 0)));
        ...
        tvm_builtin_cuda_warpgroup_sync(10);
        tirx_profile_add_epilogue(profile_state_ptr, ((warp_id_in_cta == 0) & ((((int)threadIdx.x) % 32) == 0)));
        tirx_profile_finish(profile_state_ptr, (&(Profile_ptr[((((int)blockIdx.x) * 22) + (tile_scheduler_tile_count_ptr[0] * 11))])), _ptr[0], _ptr_1[0], ((warp_id_in_cta == 0) & ((((int)threadIdx.x) % 32) == 0)));
        _ptr_2[0] = (_ptr_2[0] + 148);
        tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
        if ((bool)1 & (_ptr_2[0] < 256)) {
