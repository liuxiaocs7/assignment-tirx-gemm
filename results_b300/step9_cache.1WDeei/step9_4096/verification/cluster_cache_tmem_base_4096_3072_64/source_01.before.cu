  ...
  if ((warp_id_in_cta >> 2) == 1) {
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 512)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, 0, ((_ptr[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
          ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 33280)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, ((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
        ...
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              ptx_tcgen05_mma_cta_2_kind_f16_SS(mma_tmem_base, tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (mma_phase_stage_ptr[0] * 1024)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (mma_phase_stage_ptr[0] * 1024)), (uint)272629776, (bool)0, 0, 0, 0, 0, 0, 0, 0, 0);
    ...
    if ((warp_id_in_cta >> 2) == 0) {
      ...
      while (1) {
        ...
        int cse_v26 = ((warp_id_in_cta * 2048) + ((((int)threadIdx.x) & 31) * 64));
