  ...
  if ((warp_id_in_cta >> 2) == 2) {
        ...
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              int cse_v16 = ((warp_id_in_cta & 3) * 128);
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        int cse_v19 = ((warp_id_in_cta >> 2) * 128);
        ...
        int cse_v20 = ((warp_id_in_cta >> 2) * 16384);
        ...
        for (int f_4 = 0; f_4 < 16; ++f_4) {
          ...
          dr_ptr[0] = (f_4 * 8);
          void* s_ptr = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[82432])), (((((s_off_ptr[0] + ds_ptr[0]) >> 3) ^ ((((s_off_ptr[0] + ds_ptr[0]) >> 3) & 56) >> 3)) << 3) + ((s_off_ptr[0] + ds_ptr[0]) & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_3d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 16384) + 82432)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, 0, (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)), (_ptr_1[0] * 2));
