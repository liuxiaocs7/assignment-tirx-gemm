  ...
  if ((warp_id_in_cta >> 2) == 2) {
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        int cse_v18 = ((warp_id_in_cta >> 2) * 8192);
        int cse_v23 = ((((warp_id_in_cta >> 2) * 8192) + ((warp_id_in_cta & 3) * 1024)) + ((((int)threadIdx.x) & 31) * 32));
        ...
        int cse_v20 = ((warp_id_in_cta >> 2) * 256);
        int cse_v21 = (((warp_id_in_cta >> 2) * 8192) + 82432);
        ...
        int cse_v24 = (((((warp_id_in_cta >> 2) * 8192) + ((warp_id_in_cta & 3) * 1024)) + ((((int)threadIdx.x) & 31) * 32)) + 4096);
        ...
        tvm_builtin_ptx_fence_proxy_async_shared_cta();
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        int cse_v22 = (((warp_id_in_cta >> 2) * 8192) + 86528);
        if ((warp_id_in_cta % 4) == 0) {
          if ((((int)threadIdx.x) % 32) == 0) {
