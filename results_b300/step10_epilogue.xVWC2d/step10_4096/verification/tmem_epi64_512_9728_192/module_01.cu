  ...
  if ((warp_id_in_cta >> 2) == 2) {
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 3; ++k_1) {
                ...
                int cse_v13 = ((warp_id_in_cta & 3) * 128);
                int cse_v14 = ((warp_id_in_cta & 3) * 1024);
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        int cse_v15 = ((warp_id_in_cta >> 2) * 128);
        ...
        int cse_v18 = ((warp_id_in_cta * 2048) + ((((int)threadIdx.x) & 31) * 64));
