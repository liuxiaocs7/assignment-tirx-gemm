  ...
  if ((warp_id_in_cta >> 2) == 2) {
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        int cse_v24 = ((warp_id_in_cta >> 2) * 8192);
        int cse_v30 = ((((warp_id_in_cta >> 2) * 8192) + ((warp_id_in_cta & 3) * 1024)) + ((((int)threadIdx.x) & 31) * 32));
        s_off_ptr[0] = ((((warp_id_in_cta >> 2) * 8192) + ((warp_id_in_cta & 3) * 1024)) + ((((int)threadIdx.x) & 31) * 32));
        ...
        int cse_v28 = (((warp_id_in_cta >> 2) * 8192) + 82432);
        ...
        int cse_v31 = (((((warp_id_in_cta >> 2) * 8192) + ((warp_id_in_cta & 3) * 1024)) + ((((int)threadIdx.x) & 31) * 32)) + 4096);
        s_off_ptr_1[0] = (((((warp_id_in_cta >> 2) * 8192) + ((warp_id_in_cta & 3) * 1024)) + ((((int)threadIdx.x) & 31) * 32)) + 4096);
        ...
        tvm_builtin_ptx_fence_proxy_async_shared_cta();
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        int cse_v29 = (((warp_id_in_cta >> 2) * 8192) + 86528);
        if ((warp_id_in_cta % 4) == 0) {
          if ((((int)threadIdx.x) % 32) == 0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 8192) + 86528)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 128) + 32), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
        ...
        s_off_ptr_2[0] = ((((warp_id_in_cta >> 2) * 8192) + ((warp_id_in_cta & 3) * 1024)) + ((((int)threadIdx.x) & 31) * 32));
        ...
        s_off_ptr_3[0] = (((((warp_id_in_cta >> 2) * 8192) + ((warp_id_in_cta & 3) * 1024)) + ((((int)threadIdx.x) & 31) * 32)) + 4096);
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if ((((int)threadIdx.x) % 32) == 0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 8192) + 86528)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 128) + 96), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
