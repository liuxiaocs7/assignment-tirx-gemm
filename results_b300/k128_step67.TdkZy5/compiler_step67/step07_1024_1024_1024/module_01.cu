...
__forceinline__ __device__ void ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d(void* dst, void* mbar, unsigned long long tensormap_addr, uint16_t cta_mask, unsigned long long cache_policy, int coord0, int coord1, int coord2) {
    unsigned int dst_addr = __cvta_generic_to_shared(dst);
    unsigned int mbar_addr = __cvta_generic_to_shared(mbar);
    asm volatile(
        "cp.async.bulk.tensor.3d.shared::cluster.global.mbarrier::complete_tx::bytes.cta_group::1 [%0], [%1, {%3, %4, %5}], [%2];"
        :
...
extern "C" __global__ void __launch_bounds__(256) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  tvm_builtin_ptx_tcgen05_encode_matrix_descriptor((&(descB_ptr[0])), (&(((half*)pool_buf_ptr)[33280])), 1024, 64, 3);
  ...
  if ((warp_id_in_cta >> 2) == 1) {
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 8; ++k) {
            ...
            int cse_v6 = (k * 2);
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 16384) + 512)])), (&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, 0, (_ptr[0] * 128), (k * 2));
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 16384) + 33280)])), (&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, (_ptr_1[0] * 128), (k * 2));
            tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), 65536);
          ...
          if ((bool)1 & (_ptr_2[0] < 64)) {
            ...
            int cse_v16 = ((group_id_1 * 8) + (within_group_1 & 7));
      ...
      if ((warp_id_in_cta % 4) == 0) {
        if (tvm_builtin_elect_one_sync_op() != (uint)0) {
          ...
          while (1) {
            if (!((_ptr_2[0] < 64))) { break; }
            tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[6])), (ld_phase_phase_ptr[0] ^ 0));
            ...
            for (int k_1 = 0; k_1 < 8; ++k_1) {
              ...
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (mma_phase_stage_ptr[0] * 2048)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (mma_phase_stage_ptr[0] * 2048)), (uint)136314896, (0 < k_1), 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 2)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 2)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 4)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 4)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 6)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 6)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1024)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1024)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1026)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1026)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1028)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1028)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1030)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + 1030)), (uint)136314896, (bool)1, 0, 0, 0, 0);
              ptx_tcgen05_commit_cta_group_1((&(((uint64_t*)pool_buf_ptr)[(mma_phase_stage_ptr[0] + 3)])));
            ...
            if ((bool)1 & (_ptr_2[0] < 64)) {
              ...
              int cse_v17 = ((group_id_2 * 8) + (within_group_2 & 7));
    ...
    if ((warp_id_in_cta >> 2) == 0) {
      ...
      while (1) {
        if (!((_ptr_2[0] < 64))) { break; }
        tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[5])), (wb_phase_phase_ptr[0] ^ 0));
        ...
        int cse_v19 = ((warp_id_in_cta * 2048) + ((((int)threadIdx.x) & 31) * 64));
        ...
        for (int f_4 = 0; f_4 < 8; ++f_4) {
          ...
          dr_ptr[0] = (f_4 * 8);
          void* s_ptr = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[66048])), (((((((s_off_ptr[0] >> 3) ^ (((s_off_ptr[0] >> 3) & 56) >> 3)) << 3) + (((f_4 >> 2) & 1) * _ptr_3[0])) + (((f_4 >> 1) & 1) * _ptr_3[1])) + ((f_4 & 1) * _ptr_3[2])) + (s_off_ptr[0] & 7)));
        ...
        if (warp_id_in_cta == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[66048])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (_ptr_1[0] * 128), (_ptr[0] * 128));
        ...
        for (int f_5 = 0; f_5 < 8; ++f_5) {
          ...
          dr_ptr_1[0] = (f_5 * 8);
          void* s_ptr_1 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[66048])), (((((((s_off_ptr_1[0] >> 3) ^ (((s_off_ptr_1[0] >> 3) & 56) >> 3)) << 3) + (((f_5 >> 2) & 1) * _ptr_4[0])) + (((f_5 >> 1) & 1) * _ptr_4[1])) + ((f_5 & 1) * _ptr_4[2])) + (s_off_ptr_1[0] & 7)));
        ...
        if (warp_id_in_cta == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[66048])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 128) + 64), (_ptr[0] * 128));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
        ...
        if ((bool)1 & (_ptr_2[0] < 64)) {
          ...
          int cse_v18 = ((group_id_3 * 8) + (within_group_3 & 7));
          int tile_row_3 = ((group_id_3 * 8) + (within_group_3 & 7));
          int cse_v15 = (within_group_3 >> 3);
