...
extern "C" __global__ void __launch_bounds__(128) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap A_tensormap_1, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap B_tensormap_1, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if ((bool)1 & (((int)blockIdx.x) < 64)) {
    int cse_v3 = (((int)blockIdx.x) >> 6);
    int group_id = (((int)blockIdx.x) >> 6);
    int cse_v4 = (((int)blockIdx.x) & 63);
    int within_group = (((int)blockIdx.x) & 63);
    int cse_v14 = (((((int)blockIdx.x) >> 6) * 8) + (((int)blockIdx.x) & 7));
    int tile_row = (((((int)blockIdx.x) >> 6) * 8) + (((int)blockIdx.x) & 7));
    int cse_v8 = ((((int)blockIdx.x) & 63) >> 3);
    int tile_col = ((((int)blockIdx.x) & 63) >> 3);
    _ptr[0] = (((((int)blockIdx.x) >> 6) * 8) + (((int)blockIdx.x) & 7));
    _ptr_1[0] = ((((int)blockIdx.x) & 63) >> 3);
  } else {
    _ptr[0] = 0;
    _ptr_1[0] = 0;
  }
  ...
  while (1) {
    ...
    if ((warp_id_in_cta % 4) == 0) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d((&(((half*)pool_buf_ptr)[512])), (&(((uint64_t*)pool_buf_ptr)[1])), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, 0, (_ptr[0] * 128), 0);
        ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d((&(((half*)pool_buf_ptr)[33280])), (&(((uint64_t*)pool_buf_ptr)[1])), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, (_ptr_1[0] * 128), 0);
        tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[1])), 65536);
        ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d((&(((half*)pool_buf_ptr)[16896])), (&(((uint64_t*)pool_buf_ptr)[2])), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, 0, (_ptr[0] * 128), 2);
        ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d((&(((half*)pool_buf_ptr)[49664])), (&(((uint64_t*)pool_buf_ptr)[2])), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, (_ptr_1[0] * 128), 2);
        tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[2])), 65536);
        for (int k = 0; k < 8; ++k) {
          int cse_v5 = (k & 1);
          int cse_v9 = ((k & 1) + 1);
          ...
          int cse_v10 = ((k & 1) * 2048);
          ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((k & 1) * 2048)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], ((k & 1) * 2048)), (uint)136314896, (0 < k), 0, 0, 0, 0);
          int cse_v15 = (((k & 1) * 2048) + 2);
          ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((k & 1) * 2048) + 2)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((k & 1) * 2048) + 2)), (uint)136314896, (bool)1, 0, 0, 0, 0);
          int cse_v16 = (((k & 1) * 2048) + 4);
          ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((k & 1) * 2048) + 4)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((k & 1) * 2048) + 4)), (uint)136314896, (bool)1, 0, 0, 0, 0);
          int cse_v17 = (((k & 1) * 2048) + 6);
          ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((k & 1) * 2048) + 6)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((k & 1) * 2048) + 6)), (uint)136314896, (bool)1, 0, 0, 0, 0);
          int cse_v18 = (((k & 1) * 2048) + 1024);
          ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((k & 1) * 2048) + 1024)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((k & 1) * 2048) + 1024)), (uint)136314896, (bool)1, 0, 0, 0, 0);
          int cse_v19 = (((k & 1) * 2048) + 1026);
          ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((k & 1) * 2048) + 1026)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((k & 1) * 2048) + 1026)), (uint)136314896, (bool)1, 0, 0, 0, 0);
          int cse_v20 = (((k & 1) * 2048) + 1028);
          ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((k & 1) * 2048) + 1028)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((k & 1) * 2048) + 1028)), (uint)136314896, (bool)1, 0, 0, 0, 0);
          int cse_v21 = (((k & 1) * 2048) + 1030);
          ptx_tcgen05_mma_cta_1_kind_f16_SS(((uint*)pool_buf_ptr)[0], tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], (((k & 1) * 2048) + 1030)), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (((k & 1) * 2048) + 1030)), (uint)136314896, (bool)1, 0, 0, 0, 0);
          ...
          if (k < 6) {
            int cse_v11 = ((k & 1) * 16384);
            int cse_v12 = ((k * 2) + 4);
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d((&(((half*)pool_buf_ptr)[(((k & 1) * 16384) + 512)])), (&(((uint64_t*)pool_buf_ptr)[((k & 1) + 1)])), ((unsigned long long)(&(A_tensormap_1))), 0, (uint64_t)0, 0, (_ptr[0] * 128), ((k * 2) + 4));
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d((&(((half*)pool_buf_ptr)[(((k & 1) * 16384) + 33280)])), (&(((uint64_t*)pool_buf_ptr)[((k & 1) + 1)])), ((unsigned long long)(&(B_tensormap_1))), 0, (uint64_t)0, 0, (_ptr_1[0] * 128), ((k * 2) + 4));
            tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared((&(((uint64_t*)pool_buf_ptr)[((k & 1) + 1)])), 65536);
          }
        }
      }
    }
    ...
    if ((warp_id_in_cta % 4) == 0) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ptx_cp_async_bulk_tensor_shared_to_global_3d((&(((half*)pool_buf_ptr)[66048])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, 0, (_ptr[0] * 128), (_ptr_1[0] * 2));
