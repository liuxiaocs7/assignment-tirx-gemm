...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if ((bool)1 & (bool)1) {
    ...
    int cse_v5 = (((int)blockIdx.x) & 127);
    int within_group = ((((int)blockIdx.x) & 127) >> 1);
    int cse_v30 = (((((int)blockIdx.x) >> 7) * 4) + ((((int)blockIdx.x) & 7) >> 1));
    int tile_row = (((((int)blockIdx.x) >> 7) * 4) + ((((int)blockIdx.x) & 7) >> 1));
    int cse_v23 = ((((int)blockIdx.x) & 127) >> 3);
    int tile_col = ((((int)blockIdx.x) & 127) >> 3);
    _ptr[0] = (((((int)blockIdx.x) >> 7) * 4) + ((((int)blockIdx.x) & 7) >> 1));
  ...
  if ((warp_id_in_cta >> 2) == 2) {
      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          if ((bool)1 & (_ptr_2[0] < 128)) {
            int group_id_1 = (_ptr_2[0] >> 6);
            int within_group_1 = (_ptr_2[0] & 63);
            int cse_v24 = ((group_id_1 * 4) + (within_group_1 & 3));
            int tile_row_1 = ((group_id_1 * 4) + (within_group_1 & 3));
            int cse_v8 = (within_group_1 >> 2);
            int tile_col_1 = (within_group_1 >> 2);
            _ptr[0] = ((group_id_1 * 4) + (within_group_1 & 3));
            _ptr_1[0] = (within_group_1 >> 2);
          } else {
            _ptr[0] = 0;
            _ptr_1[0] = 0;
          }
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 64; ++k_1) {
                ...
                uint cse_v31 = ((uint)((warp_id_in_cta & 3) * 256));
              ...
              tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
              if ((bool)1 & (_ptr_2[0] < 128)) {
                int group_id_2 = (_ptr_2[0] >> 6);
                int within_group_2 = (_ptr_2[0] & 63);
                int cse_v26 = ((group_id_2 * 4) + (within_group_2 & 3));
                int tile_row_2 = ((group_id_2 * 4) + (within_group_2 & 3));
                int cse_v9 = (within_group_2 >> 2);
                int tile_col_2 = (within_group_2 >> 2);
                _ptr[0] = ((group_id_2 * 4) + (within_group_2 & 3));
                _ptr_1[0] = (within_group_2 >> 2);
              } else {
                _ptr[0] = 0;
                _ptr_1[0] = 0;
              }
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        int cse_v32 = ((warp_id_in_cta * 2048) + ((((int)threadIdx.x) & 31) * 64));
        ...
        int cse_v33 = (((warp_id_in_cta >> 2) * 8192) + 98816);
        ...
        tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
        if ((bool)1 & (_ptr_2[0] < 128)) {
          int group_id_3 = (_ptr_2[0] >> 6);
          int within_group_3 = (_ptr_2[0] & 63);
          int cse_v29 = ((group_id_3 * 4) + (within_group_3 & 3));
          int tile_row_3 = ((group_id_3 * 4) + (within_group_3 & 3));
          int cse_v22 = (within_group_3 >> 2);
          int tile_col_3 = (within_group_3 >> 2);
          _ptr[0] = ((group_id_3 * 4) + (within_group_3 & 3));
          _ptr_1[0] = (within_group_3 >> 2);
        } else {
          _ptr[0] = 0;
          _ptr_1[0] = 0;
        }
