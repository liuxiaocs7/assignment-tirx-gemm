  ...
  if ((warp_id_in_cta >> 2) == 2) {
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        int cse_v23 = ((warp_id_in_cta >> 2) * 16384);
        int cse_v28 = ((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64));
        s_off_ptr[0] = ((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64));
        for (int f_8 = 0; f_8 < 16; ++f_8) {
          alignas(64) int ds_ptr[1];
          ds_ptr[0] = (((f_8 >> 3) * 8192) + ((f_8 & 7) * 8));
        ...
        int cse_v26 = (((warp_id_in_cta >> 2) * 16384) + 74240);
        ...
        for (int f_9 = 0; f_9 < 16; ++f_9) {
          ...
          void* r_ptr_1 = (void*)tvm_builtin_pointer_offset((&(Dreg_f16_ptr[0])), (dr_ptr_1[0] + 128));
