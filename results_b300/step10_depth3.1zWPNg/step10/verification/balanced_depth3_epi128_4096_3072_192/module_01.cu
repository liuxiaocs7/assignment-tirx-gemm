  ...
  if ((warp_id_in_cta >> 2) == 2) {
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        int cse_v24 = ((warp_id_in_cta >> 2) * 16384);
        int cse_v29 = ((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64));
        ...
        int cse_v27 = (((warp_id_in_cta >> 2) * 16384) + 74240);
