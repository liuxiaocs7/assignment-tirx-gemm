  ...
  if ((warp_id_in_cta >> 2) == 2) {
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 3; ++k_1) {
                ...
                int cse_v11 = ((warp_id_in_cta & 3) * 64);
                int cse_v12 = ((warp_id_in_cta & 3) * 1024);
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        int cse_v13 = ((warp_id_in_cta >> 2) * 64);
        ...
        int cse_v16 = ((warp_id_in_cta * 1024) + ((((int)threadIdx.x) & 31) * 32));
        ...
        tvm_builtin_ptx_fence_proxy_async_shared_cta();
        int cse_v14 = ((warp_id_in_cta >> 2) + 10);
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        int cse_v15 = ((warp_id_in_cta >> 2) * 256);
        int cse_v17 = (((warp_id_in_cta >> 2) * 4096) + 92672);
