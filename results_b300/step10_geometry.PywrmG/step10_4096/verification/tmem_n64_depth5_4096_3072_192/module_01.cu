  ...
  if ((warp_id_in_cta >> 2) == 2) {
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 3; ++k_1) {
                ...
                int cse_v17 = ((warp_id_in_cta & 3) * 64);
                int cse_v18 = ((warp_id_in_cta & 3) * 1024);
              ...
              if ((bool)1 & (_ptr_2[0] < 384)) {
                ...
                int cse_v19 = ((group_id_2 * 8) + (within_group_2 & 7));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        int cse_v20 = ((warp_id_in_cta >> 2) * 64);
        ...
        int cse_v24 = ((warp_id_in_cta * 1024) + ((((int)threadIdx.x) & 31) * 32));
        ...
        if ((bool)1 & (_ptr_2[0] < 384)) {
          ...
          int cse_v23 = ((group_id_3 * 8) + (within_group_3 & 7));
