    ...
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 2048) + 66048)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, ((_ptr_1[0] * 64) + (((int)tvm_builtin_cluster_ctaid_x()) * 32)));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        for (int f_2 = 0; f_2 < 4; ++f_2) {
          ...
          dr_ptr[0] = (f_2 * 8);
          void* s_ptr = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[74240])), ((((((s_off_ptr[0] >> 3) ^ (((s_off_ptr[0] >> 3) & 24) >> 3)) << 3) + (((f_2 >> 1) & 1) * _ptr_3[0])) + ((f_2 & 1) * _ptr_3[1])) + (s_off_ptr[0] & 7)));
        ...
        int cse_v24 = (((warp_id_in_cta >> 2) * 4096) + 74240);
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 74240)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (_ptr_1[0] * 64), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
        ...
        for (int f_3 = 0; f_3 < 4; ++f_3) {
          ...
          dr_ptr_1[0] = (f_3 * 8);
          void* s_ptr_1 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[74240])), ((((((s_off_ptr_1[0] >> 3) ^ (((s_off_ptr_1[0] >> 3) & 24) >> 3)) << 3) + (((f_3 >> 1) & 1) * _ptr_4[0])) + ((f_3 & 1) * _ptr_4[1])) + (s_off_ptr_1[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 4096) + 74240)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 64) + 32), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_0();
          }
        }
