...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if ((bool)1 & (bool)1) {
    ...
    int cse_v15 = ((((int)blockIdx.x) & 15) >> 1);
    ...
    int cse_v16 = ((((int)blockIdx.x) >> 1) - 320);
    int rem = ((((int)blockIdx.x) >> 1) - 320);
    int tile_row_1 = 8;
    int tile_col_1 = ((((int)blockIdx.x) >> 1) - 320);
    _ptr[0] = 8;
    _ptr_1[0] = ((((int)blockIdx.x) >> 1) - 320);
  }
  ...
  if ((warp_id_in_cta >> 2) == 2) {
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        #pragma unroll 1
        while (1) {
          if (!((_ptr_2[0] < 360))) { break; }
          for (int k = 0; k < 5; ++k) {
            tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 6)])), (tma_phase_phase_ptr[0] ^ 0));
            int cse_v6 = (k * 64);
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 2048) + 82432)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), ((_ptr_1[0] * 64) + (((int)tvm_builtin_cluster_ctaid_x()) * 32)));
          ...
          if ((bool)1 & (_ptr_2[0] < 320)) {
            int group_id_1 = ((_ptr_2[0] / 320) + ((_ptr_2[0] % 320) >> 31));
            int within_group_1 = ((_ptr_2[0] % 320) + (320 & ((_ptr_2[0] % 320) >> 31)));
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 5; ++k_1) {
                ...
                int cse_v18 = ((warp_id_in_cta & 3) * 64);
                int cse_v19 = ((warp_id_in_cta & 3) * 1024);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((mma_tmem_base + ((uint)((ld_phase_stage_ptr[0] * 128) + ((warp_id_in_cta & 3) * 64)))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + ((warp_id_in_cta & 3) * 1024))), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (mma_phase_stage_ptr[0] * 256)), (uint)269484048, (0 < k_1), 0, 0, 0, 0, 0, 0, 0, 0);
              ...
              tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
              if ((bool)1 & (_ptr_2[0] < 320)) {
                int group_id_2 = ((_ptr_2[0] / 320) + ((_ptr_2[0] % 320) >> 31));
                int within_group_2 = ((_ptr_2[0] % 320) + (320 & ((_ptr_2[0] % 320) >> 31)));
                int cse_v20 = ((group_id_2 * 8) + (within_group_2 & 7));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        int cse_v21 = ((warp_id_in_cta >> 2) * 64);
        ...
        int cse_v25 = ((warp_id_in_cta * 1024) + ((((int)threadIdx.x) & 31) * 32));
