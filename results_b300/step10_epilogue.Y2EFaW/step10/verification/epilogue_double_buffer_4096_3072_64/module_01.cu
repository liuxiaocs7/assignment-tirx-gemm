...
__forceinline__ __device__ void ptx_cp_async_bulk_wait_group_read_1() {
...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if ((bool)1 & (bool)1) {
    ...
    int cse_v22 = ((((int)blockIdx.x) & 15) >> 1);
  ...
  if ((warp_id_in_cta >> 2) == 2) {
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 4)])), (tma_phase_phase_ptr[0] ^ 0));
          ...
          ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 49664)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, ((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
          ...
          if ((bool)1 & (_ptr_2[0] < 96)) {
            ...
            int cse_v23 = ((group_id_1 * 8) + (within_group_1 & 7));
      ...
      if ((warp_id_in_cta & 3) < 2) {
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              if (!((_ptr_2[0] < 96))) { break; }
              tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[((warp_id_in_cta & 3) + 9)])), (ld_phase_phase_ptr[0] ^ 0));
              ...
              int cse_v24 = ((warp_id_in_cta & 3) * 1024);
              ...
              ptx_tcgen05_commit_cta_group_2_multicast((&(((uint64_t*)pool_buf_ptr)[(mma_phase_stage_ptr[0] + 4)])), 3);
              mma_phase_stage_ptr[0] = (mma_phase_stage_ptr[0] + 1);
              if (mma_phase_stage_ptr[0] == 3) {
                mma_phase_stage_ptr[0] = 0;
              ...
              if ((bool)1 & (_ptr_2[0] < 96)) {
                ...
                int cse_v25 = ((group_id_2 * 8) + (within_group_2 & 7));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        if (!((_ptr_2[0] < 96))) { break; }
        tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[((warp_id_in_cta >> 2) + 7)])), (wb_phase_phase_ptr[0] ^ 0));
        ...
        int cse_v27 = ((warp_id_in_cta >> 2) * 16384);
        int cse_v33 = ((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64));
        ...
        for (int f_8 = 0; f_8 < 8; ++f_8) {
          ...
          dr_ptr[0] = (f_8 * 8);
          void* s_ptr = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[74240])), (((((((s_off_ptr[0] >> 3) ^ (((s_off_ptr[0] >> 3) & 56) >> 3)) << 3) + (((f_8 >> 2) & 1) * _ptr_3[0])) + (((f_8 >> 1) & 1) * _ptr_3[1])) + ((f_8 & 1) * _ptr_3[2])) + (s_off_ptr[0] & 7)));
        ...
        int cse_v30 = (((warp_id_in_cta >> 2) * 16384) + 74240);
        if ((warp_id_in_cta % 4) == 0) {
          if ((((int)threadIdx.x) % 32) == 0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 16384) + 74240)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, (_ptr_1[0] * 256), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
          }
        }
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        alignas(64) int s_off_ptr_1[1];
        int cse_v34 = (((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64)) + 8192);
        s_off_ptr_1[0] = (((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64)) + 8192);
        ...
        for (int f_9 = 0; f_9 < 8; ++f_9) {
          ...
          dr_ptr_1[0] = (f_9 * 8);
          void* s_ptr_1 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[74240])), (((((((s_off_ptr_1[0] >> 3) ^ (((s_off_ptr_1[0] >> 3) & 56) >> 3)) << 3) + (((f_9 >> 2) & 1) * _ptr_4[0])) + (((f_9 >> 1) & 1) * _ptr_4[1])) + ((f_9 & 1) * _ptr_4[2])) + (s_off_ptr_1[0] & 7)));
        ...
        tvm_builtin_ptx_fence_proxy_async_shared_cta();
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        int cse_v31 = (((warp_id_in_cta >> 2) * 16384) + 82432);
        if ((warp_id_in_cta % 4) == 0) {
          if ((((int)threadIdx.x) % 32) == 0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 16384) + 82432)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 256) + 64), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_1();
          }
        }
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        alignas(64) int s_off_ptr_2[1];
        s_off_ptr_2[0] = ((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64));
        ...
        for (int f_10 = 0; f_10 < 8; ++f_10) {
          ...
          dr_ptr_2[0] = (f_10 * 8);
          void* s_ptr_2 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[74240])), (((((((s_off_ptr_2[0] >> 3) ^ (((s_off_ptr_2[0] >> 3) & 56) >> 3)) << 3) + (((f_10 >> 2) & 1) * _ptr_5[0])) + (((f_10 >> 1) & 1) * _ptr_5[1])) + ((f_10 & 1) * _ptr_5[2])) + (s_off_ptr_2[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if ((((int)threadIdx.x) % 32) == 0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 16384) + 74240)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 256) + 128), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
            ptx_cp_async_bulk_wait_group_read_1();
          }
        }
        ...
        s_off_ptr_3[0] = (((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64)) + 8192);
        ...
        for (int f_11 = 0; f_11 < 8; ++f_11) {
          ...
          dr_ptr_3[0] = (f_11 * 8);
          void* s_ptr_3 = (void*)tvm_builtin_pointer_offset((&(((half*)pool_buf_ptr)[74240])), (((((((s_off_ptr_3[0] >> 3) ^ (((s_off_ptr_3[0] >> 3) & 56) >> 3)) << 3) + (((f_11 >> 2) & 1) * _ptr_6[0])) + (((f_11 >> 1) & 1) * _ptr_6[1])) + ((f_11 & 1) * _ptr_6[2])) + (s_off_ptr_3[0] & 7)));
        ...
        if ((warp_id_in_cta % 4) == 0) {
          if ((((int)threadIdx.x) % 32) == 0) {
            ptx_cp_async_bulk_tensor_shared_to_global_2d((&(((half*)pool_buf_ptr)[(((warp_id_in_cta >> 2) * 16384) + 82432)])), ((unsigned long long)(&(D_tensormap))), (uint64_t)0, ((_ptr_1[0] * 256) + 192), (((_ptr[0] * 512) + ((warp_id_in_cta >> 2) * 256)) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_commit_group();
