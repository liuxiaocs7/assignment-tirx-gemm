def hgemm_v10(M, N, K):
    ...
    D_layout = mma_shared_layout(d_type, SwizzleMode.SWIZZLE_128B_ATOM, (NUM_CONSUMER, 2, BLK_M, EPI_N))
    ...
    def kernel(
        ...
        Dsmem = pool.alloc((NUM_CONSUMER, 2, BLK_M, EPI_N), d_type, layout=D_layout)
        pool.commit()
