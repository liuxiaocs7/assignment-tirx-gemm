  ...
  if ((warp_id_in_cta >> 2) == 2) {
      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 5; ++k) {
            ...
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 49664)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), ((_ptr_1[0] * 256) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 5; ++k_1) {
                ...
                uint cse_v33 = (mma_tmem_base + ((uint)((warp_id_in_cta & 3) * 256)));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        int cse_v28 = ((warp_id_in_cta >> 2) * 16384);
        int cse_v34 = ((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64));
        ...
        int cse_v31 = (((warp_id_in_cta >> 2) * 16384) + 74240);
        ...
        int cse_v35 = (((((warp_id_in_cta >> 2) * 16384) + ((warp_id_in_cta & 3) * 2048)) + ((((int)threadIdx.x) & 31) * 64)) + 8192);
        ...
        tvm_builtin_ptx_fence_proxy_async_shared_cta();
        tvm_builtin_cuda_warpgroup_sync(((warp_id_in_cta >> 2) + 10));
        int cse_v32 = (((warp_id_in_cta >> 2) * 16384) + 82432);
        if ((warp_id_in_cta % 4) == 0) {
          if ((((int)threadIdx.x) % 32) == 0) {
        ...
        if ((bool)1 & (_ptr_2[0] < 96)) {
          ...
          int cse_v30 = ((group_id_3 * 8) + (within_group_3 & 7));
