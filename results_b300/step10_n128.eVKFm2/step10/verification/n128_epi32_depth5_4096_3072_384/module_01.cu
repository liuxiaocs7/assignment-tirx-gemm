  ...
  if ((warp_id_in_cta >> 2) == 2) {
      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 6; ++k) {
            ...
            int cse_v6 = (k * 64);
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 4096) + 82432)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, (k * 64), ((_ptr_1[0] * 128) + (((int)tvm_builtin_cluster_ctaid_x()) * 64)));
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 6; ++k_1) {
                ...
                uint cse_v29 = (mma_tmem_base + ((uint)((warp_id_in_cta & 3) * 128)));
                ptx_tcgen05_mma_cta_2_kind_f16_SS((mma_tmem_base + ((uint)((warp_id_in_cta & 3) * 128))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 2048) + ((warp_id_in_cta & 3) * 1024))), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (mma_phase_stage_ptr[0] * 512)), (uint)270532624, (0 < k_1), 0, 0, 0, 0, 0, 0, 0, 0);
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tvm_builtin_ptx_tcgen05_fence_after_thread_sync();
        int cse_v23 = ((warp_id_in_cta >> 2) * 128);
        ...
        int cse_v25 = ((warp_id_in_cta >> 2) * 256);
        int cse_v28 = (((warp_id_in_cta >> 2) * 4096) + 102912);
