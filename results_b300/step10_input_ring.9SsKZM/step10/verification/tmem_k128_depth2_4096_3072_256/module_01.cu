      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 2; ++k) {
            ...
            int cse_v6 = (k * 2);
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_3d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 8192) + 66048)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr[tma_phase_stage_ptr[0]]))), ((unsigned long long)(&(B_tensormap))), 0, (uint64_t)0, 0, ((_ptr_1[0] * 128) + (((int)tvm_builtin_cluster_ctaid_x()) * 64)), (k * 2));
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 2; ++k_1) {
                ...
                int cse_v22 = ((warp_id_in_cta & 3) * 2048);
                ptx_tcgen05_mma_cta_2_kind_f16_SS((mma_tmem_base + ((uint)((ld_phase_stage_ptr[0] * 256) + ((warp_id_in_cta & 3) * 128)))), tvm_builtin_smem_desc_add_16B_offset(descA_ptr[0], ((mma_phase_stage_ptr[0] * 4096) + ((warp_id_in_cta & 3) * 2048))), tvm_builtin_smem_desc_add_16B_offset(descB_ptr[0], (mma_phase_stage_ptr[0] * 1024)), (uint)270532624, (0 < k_1), 0, 0, 0, 0, 0, 0, 0, 0);
