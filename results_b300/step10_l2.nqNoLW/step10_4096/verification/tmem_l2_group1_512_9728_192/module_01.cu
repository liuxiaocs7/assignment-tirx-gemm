  ...
  if ((warp_id_in_cta >> 2) == 2) {
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          if ((bool)1 & (_ptr_2[0] < 76)) {
            int group_id_1 = ((_ptr_2[0] / 76) + ((_ptr_2[0] % 76) >> 31));
            int within_group_1 = ((_ptr_2[0] % 76) + (76 & ((_ptr_2[0] % 76) >> 31)));
        ...
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
              if ((bool)1 & (_ptr_2[0] < 76)) {
                int group_id_2 = ((_ptr_2[0] / 76) + ((_ptr_2[0] % 76) >> 31));
                int within_group_2 = ((_ptr_2[0] % 76) + (76 & ((_ptr_2[0] % 76) >> 31)));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
        if ((bool)1 & (_ptr_2[0] < 76)) {
          int group_id_3 = ((_ptr_2[0] / 76) + ((_ptr_2[0] % 76) >> 31));
          int within_group_3 = ((_ptr_2[0] % 76) + (76 & ((_ptr_2[0] % 76) >> 31)));
