...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if ((bool)1 & (bool)1) {
    int cse_v4 = (((int)blockIdx.x) / 96);
    int group_id = (((int)blockIdx.x) / 96);
    int cse_v5 = (((int)blockIdx.x) % 96);
    int within_group = ((((int)blockIdx.x) % 96) >> 1);
    int cse_v27 = (((((int)blockIdx.x) / 96) * 2) + ((((int)blockIdx.x) & 3) >> 1));
    int tile_row = (((((int)blockIdx.x) / 96) * 2) + ((((int)blockIdx.x) & 3) >> 1));
    int cse_v18 = ((((int)blockIdx.x) % 96) >> 2);
    int tile_col = ((((int)blockIdx.x) % 96) >> 2);
    _ptr[0] = (((((int)blockIdx.x) / 96) * 2) + ((((int)blockIdx.x) & 3) >> 1));
    _ptr_1[0] = ((((int)blockIdx.x) % 96) >> 2);
  } else {
    _ptr[0] = 0;
    _ptr_1[0] = 0;
  }
  ...
  if ((warp_id_in_cta >> 2) == 2) {
      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          if ((bool)1 & (_ptr_2[0] < 192)) {
            int group_id_1 = ((_ptr_2[0] / 48) + ((_ptr_2[0] % 48) >> 31));
            int within_group_1 = ((_ptr_2[0] % 48) + (48 & ((_ptr_2[0] % 48) >> 31)));
            int cse_v19 = ((group_id_1 * 2) + (within_group_1 & 1));
            int tile_row_1 = ((group_id_1 * 2) + (within_group_1 & 1));
            int cse_v7 = (within_group_1 >> 1);
            int tile_col_1 = (within_group_1 >> 1);
            _ptr[0] = ((group_id_1 * 2) + (within_group_1 & 1));
            _ptr_1[0] = (within_group_1 >> 1);
          } else {
            _ptr[0] = 0;
            _ptr_1[0] = 0;
          }
        ...
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
              if ((bool)1 & (_ptr_2[0] < 192)) {
                int group_id_2 = ((_ptr_2[0] / 48) + ((_ptr_2[0] % 48) >> 31));
                int within_group_2 = ((_ptr_2[0] % 48) + (48 & ((_ptr_2[0] % 48) >> 31)));
                int cse_v22 = ((group_id_2 * 2) + (within_group_2 & 1));
                int tile_row_2 = ((group_id_2 * 2) + (within_group_2 & 1));
                int cse_v8 = (within_group_2 >> 1);
                int tile_col_2 = (within_group_2 >> 1);
                _ptr[0] = ((group_id_2 * 2) + (within_group_2 & 1));
                _ptr_1[0] = (within_group_2 >> 1);
              } else {
                _ptr[0] = 0;
                _ptr_1[0] = 0;
              }
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
        if ((bool)1 & (_ptr_2[0] < 192)) {
          int group_id_3 = ((_ptr_2[0] / 48) + ((_ptr_2[0] % 48) >> 31));
          int within_group_3 = ((_ptr_2[0] % 48) + (48 & ((_ptr_2[0] % 48) >> 31)));
          int cse_v26 = ((group_id_3 * 2) + (within_group_3 & 1));
          int tile_row_3 = ((group_id_3 * 2) + (within_group_3 & 1));
          int cse_v17 = (within_group_3 >> 1);
          int tile_col_3 = (within_group_3 >> 1);
          _ptr[0] = ((group_id_3 * 2) + (within_group_3 & 1));
          _ptr_1[0] = (within_group_3 >> 1);
        } else {
          _ptr[0] = 0;
          _ptr_1[0] = 0;
        }
