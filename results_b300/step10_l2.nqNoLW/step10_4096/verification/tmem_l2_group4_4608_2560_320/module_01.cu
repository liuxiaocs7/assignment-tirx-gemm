...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  if ((bool)1 & (bool)1) {
    ...
    int cse_v19 = ((((int)blockIdx.x) & 7) >> 1);
  ...
  if ((warp_id_in_cta >> 2) == 2) {
      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          if ((bool)1 & (_ptr_2[0] < 160)) {
            int group_id_1 = ((_ptr_2[0] / 80) + ((_ptr_2[0] % 80) >> 31));
            int within_group_1 = ((_ptr_2[0] % 80) + (80 & ((_ptr_2[0] % 80) >> 31)));
            int cse_v21 = ((group_id_1 * 4) + (within_group_1 & 3));
            int tile_row_2 = ((group_id_1 * 4) + (within_group_1 & 3));
            int cse_v8 = (within_group_1 >> 2);
            int tile_col_2 = (within_group_1 >> 2);
        ...
        if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
              if ((bool)1 & (_ptr_2[0] < 160)) {
                int group_id_2 = ((_ptr_2[0] / 80) + ((_ptr_2[0] % 80) >> 31));
                int within_group_2 = ((_ptr_2[0] % 80) + (80 & ((_ptr_2[0] % 80) >> 31)));
                int cse_v24 = ((group_id_2 * 4) + (within_group_2 & 3));
                int tile_row_4 = ((group_id_2 * 4) + (within_group_2 & 3));
                int cse_v9 = (within_group_2 >> 2);
                int tile_col_4 = (within_group_2 >> 2);
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tile_scheduler_tile_count_ptr[0] = (tile_scheduler_tile_count_ptr[0] + 1);
        if ((bool)1 & (_ptr_2[0] < 160)) {
          int group_id_3 = ((_ptr_2[0] / 80) + ((_ptr_2[0] % 80) >> 31));
          int within_group_3 = ((_ptr_2[0] % 80) + (80 & ((_ptr_2[0] % 80) >> 31)));
          int cse_v28 = ((group_id_3 * 4) + (within_group_3 & 3));
          int tile_row_6 = ((group_id_3 * 4) + (within_group_3 & 3));
          int cse_v18 = (within_group_3 >> 2);
          int tile_col_6 = (within_group_3 >> 2);
