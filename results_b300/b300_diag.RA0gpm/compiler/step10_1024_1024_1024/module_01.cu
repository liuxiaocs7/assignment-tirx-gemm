...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  int cse_v26 = ((((int)blockIdx.x) & 3) >> 1);
  int tile_row = ((((int)blockIdx.x) & 3) >> 1);
  int cse_v5 = (((int)blockIdx.x) >> 2);
  int tile_col = (((int)blockIdx.x) >> 2);
  _ptr[0] = ((((int)blockIdx.x) & 3) >> 1);
  _ptr_1[0] = (((int)blockIdx.x) >> 2);
  ...
  if ((warp_id_in_cta >> 2) == 2) {
    if ((warp_id_in_cta & 3) == 3) {
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          int rem_1 = _ptr_2[0];
          int cse_v8 = (rem_1 & 1);
          int tile_row_1 = (rem_1 & 1);
          int cse_v9 = (rem_1 >> 1);
          int tile_col_1 = (rem_1 >> 1);
          _ptr[0] = (rem_1 & 1);
          _ptr_1[0] = (rem_1 >> 1);
        }
      }
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 16; ++k_1) {
                ...
                int cse_v27 = ((warp_id_in_cta & 3) * 1024);
              ...
              int rem_2 = _ptr_2[0];
              int cse_v10 = (rem_2 & 1);
              int tile_row_2 = (rem_2 & 1);
              int cse_v11 = (rem_2 >> 1);
              int tile_col_2 = (rem_2 >> 1);
              _ptr[0] = (rem_2 & 1);
              _ptr_1[0] = (rem_2 >> 1);
            }
          }
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        int rem_3 = _ptr_2[0];
        int cse_v24 = (rem_3 & 1);
        int tile_row_3 = (rem_3 & 1);
        int cse_v25 = (rem_3 >> 1);
        int tile_col_3 = (rem_3 >> 1);
        _ptr[0] = (rem_3 & 1);
        _ptr_1[0] = (rem_3 >> 1);
      }
    }
