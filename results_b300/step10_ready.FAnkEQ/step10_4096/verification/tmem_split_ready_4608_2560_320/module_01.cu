...
extern "C" __global__ void __launch_bounds__(384) kernel_kernel(const __grid_constant__ CUtensorMap A_tensormap, const __grid_constant__ CUtensorMap B_tensormap, const __grid_constant__ CUtensorMap D_tensormap) {
  ...
  uint64_t* remote_mbar_ptr_1 = (uint64_t*)((uint64_t*)tvm_builtin_ptx_mapa_u64((&(((uint64_t*)pool_buf_ptr)[17])), 0));
  ...
  if ((warp_id_in_cta >> 2) == 2) {
      ...
      if (tvm_builtin_elect_one_sync_op() != (uint)0) {
        ...
        while (1) {
          ...
          for (int k = 0; k < 5; ++k) {
            ...
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 16384) + 512)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr_1[(tma_phase_stage_ptr[0] * 2)]))), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, (k * 64), ((_ptr[0] * 512) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)));
            ptx_cp_async_bulk_tensor_g2s_cluster_tile_2d_mbar_addr((&(((half*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 16384) + 8704)])), tvm_builtin_cuda_cvta_generic_to_shared((&(remote_mbar_ptr_1[((tma_phase_stage_ptr[0] * 2) + 1)]))), ((unsigned long long)(&(A_tensormap))), 0, (uint64_t)0, (k * 64), (((_ptr[0] * 512) + (((int)tvm_builtin_cluster_ctaid_x()) * 128)) + 256));
            if (((int)tvm_builtin_cluster_ctaid_x()) == 0) {
              alignas(64) bool actual_pred_ptr[1];
              actual_pred_ptr[0] = (bool)1;
              tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared_cluster_remote_pred((&(((uint64_t*)pool_buf_ptr)[(tma_phase_stage_ptr[0] + 1)])), 16384, 0, actual_pred_ptr[0]);
              alignas(64) bool actual_pred_ptr_1[1];
              actual_pred_ptr_1[0] = (bool)1;
              tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared_cluster_remote_pred((&(((uint64_t*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 2) + 17)])), 32768, 0, actual_pred_ptr_1[0]);
              alignas(64) bool actual_pred_ptr_2[1];
              actual_pred_ptr_2[0] = (bool)1;
              tvm_builtin_ptx_mbarrier_arrive_expect_tx_shared_cluster_remote_pred((&(((uint64_t*)pool_buf_ptr)[((tma_phase_stage_ptr[0] * 2) + 18)])), 32768, 0, actual_pred_ptr_2[0]);
            }
          ...
          if (tvm_builtin_elect_one_sync_op() != (uint)0) {
            ...
            while (1) {
              ...
              for (int k_1 = 0; k_1 < 5; ++k_1) {
                ...
                tvm_builtin_ptx_mbarrier_try_wait((&(((uint64_t*)pool_buf_ptr)[(((mma_phase_stage_ptr[0] * 2) + (warp_id_in_cta & 3)) + 17)])), (mma_phase_phase_ptr[0] ^ 0));
    ...
    if (warp_id_in_cta < 8) {
      ...
      while (1) {
        ...
        tvm_builtin_ptx_mbarrier_arrive_shared_cluster_remote_pred((&(((uint64_t*)pool_buf_ptr)[(((wb_phase_stage_ptr[0] * 2) + (warp_id_in_cta >> 2)) + 13)])), 0, actual_pred_ptr_3[0]);
